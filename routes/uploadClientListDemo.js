...
let fileName ='C:\\Users\\Administrator\\Desktop\\111.txt';
let savaFileName ='C:\\Users\\Administrator\\Desktop\\111.json';
fs.readFile(fileName, function (err, data) {
 ...
 //  console.log("异步读取文件数据: " + data.toString());
        ...
        let temp1 = data.toString();
          ...
          temp1 = temp1.replace(/"最后跟进记录"/g,'"final_follow_up_record"');
          temp1 = temp1.replace(/}/g,'\,"key":"1","international_waters":"0","call_status":"0","call_count":"0","open_show":"false","userid":"0"}');
