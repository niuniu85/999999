...
console.log(temp);
 let objArrayLenght = temp.length;
 console.log('length:'+objArrayLenght);
 let temp3;
for(let i =0; i<objArrayLenght; i++){
 let temp1 = JSON.stringify(temp[i]);
...
console.log(temp3);
// temp3='['+temp3.toString().replace(/\'/g,'')+']';
// console.log(temp3);
 // jsonHeadler(temp);
